...
class MealInfoApp {
    ...
    async searchMealInfo() {
        ...
        if (dayOfWeek === 0 || dayOfWeek === 6) {
            this.showError('주말에는 급식 정보가 없습니다.');
            return;
        }
    ...
    async fetchMealData(date) {
        ...
        try {
            ...
            const dummyData = {
                ...
                '2025-06-17': {
                    menu: '*미역국 (1.5.6.9)<br/>*제육볶음 (5.6.13.16)<br/>*시금치나물 (5.6.13)<br/>김치찌개 (5.6.9.13)<br/>멸치볶음 (5.6.13)<br/>깍두기 (9)<br/>*바나나 (13)',
                    nutrition: '단백질(g) : 32.1<br/>지방(g) : 15.8<br/>비타민A(R.E) : 28.5<br/>티아민(mg) : 0.4<br/>리보플라빈(mg) : 0.6<br/>비타민C(mg) : 12.3<br/>칼슘(mg) : 198.7<br/>철분(mg) : 3.8',
                    calories: '약 750kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                },
                '2025-06-18': {
                    menu: '*된장찌개 (5.6.9.13)<br/>*닭볶음탕 (5.6.13.16)<br/>*콩나물무침 (5.6.13)<br/>계란말이 (1.5.6.13)<br/>시금치나물 (5.6.13)<br/>김치 (9)<br/>*오렌지 (13)',
                    nutrition: '단백질(g) : 38.2<br/>지방(g) : 18.9<br/>비타민A(R.E) : 22.1<br/>티아민(mg) : 0.5<br/>리보플라빈(mg) : 0.7<br/>비타민C(mg) : 15.6<br/>칼슘(mg) : 245.3<br/>철분(mg) : 4.7',
                    calories: '약 820kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                },
                '2025-06-19': {
                    menu: '*순두부찌개 (5.6.9.13)<br/>*불고기 (5.6.13.16)<br/>*나물무침 (5.6.13)<br/>계란찜 (1.5.6.13)<br/>김치나물 (5.6.13)<br/>깍두기 (9)<br/>*사과 (13)',
                    nutrition: '단백질(g) : 36.7<br/>지방(g) : 16.4<br/>비타민A(R.E) : 26.8<br/>티아민(mg) : 0.3<br/>리보플라빈(mg) : 0.5<br/>비타민C(mg) : 9.2<br/>칼슘(mg) : 212.5<br/>철분(mg) : 4.1',
                    calories: '약 780kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                },
                '2025-06-20': {
                    menu: '*김치찌개 (5.6.9.13)<br/>*돈까스 (1.5.6.13.16)<br/>*양배추샐러드 (5.6.13)<br/>미역국 (1.5.6.9)<br/>단무지 (5.6.13)<br/>깍두기 (9)<br/>*포도 (13)',
                    nutrition: '단백질(g) : 34.9<br/>지방(g) : 19.2<br/>비타민A(R.E) : 24.3<br/>티아민(mg) : 0.4<br/>리보플라빈(mg) : 0.6<br/>비타민C(mg) : 11.8<br/>칼슘(mg) : 203.6<br/>철분(mg) : 3.9',
                    calories: '약 850kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                }
            };
            ...
            // 다른 날짜의 경우 기본 더미 데이터 반환
            const randomMenus = [
                {
                    menu: '*된장국 (5.6.9.13)<br/>*제육볶음 (5.6.13.16)<br/>*시금치나물 (5.6.13)<br/>계란말이 (1.5.6.13)<br/>김치 (9)<br/>깍두기 (9)<br/>*바나나 (13)',
                    nutrition: '단백질(g) : 33.5<br/>지방(g) : 16.8<br/>비타민A(R.E) : 25.7<br/>티아민(mg) : 0.4<br/>리보플라빈(mg) : 0.5<br/>비타민C(mg) : 10.2<br/>칼슘(mg) : 208.9<br/>철분(mg) : 4.0',
                    calories: '약 780kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                },
                {
                    menu: '*미역국 (1.5.6.9)<br/>*닭볶음탕 (5.6.13.16)<br/>*콩나물무침 (5.6.13)<br/>김치찌개 (5.6.9.13)<br/>멸치볶음 (5.6.13)<br/>깍두기 (9)<br/>*사과 (13)',
                    nutrition: '단백질(g) : 35.2<br/>지방(g) : 17.1<br/>비타민A(R.E) : 26.3<br/>티아민(mg) : 0.3<br/>리보플라빈(mg) : 0.6<br/>비타민C(mg) : 12.5<br/>칼슘(mg) : 215.7<br/>철분(mg) : 4.3',
                    calories: '약 800kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                },
                {
                    menu: '*순두부찌개 (5.6.9.13)<br/>*불고기 (5.6.13.16)<br/>*나물무침 (5.6.13)<br/>계란찜 (1.5.6.13)<br/>김치나물 (5.6.13)<br/>깍두기 (9)<br/>*오렌지 (13)',
                    nutrition: '단백질(g) : 37.8<br/>지방(g) : 18.5<br/>비타민A(R.E) : 23.9<br/>티아민(mg) : 0.5<br/>리보플라빈(mg) : 0.7<br/>비타민C(mg) : 14.1<br/>칼슘(mg) : 238.4<br/>철분(mg) : 4.6',
                    calories: '약 820kcal',
                    allergy: '알레르기 정보: 1,5,6,9,13,16'
                }
            ];
            
            // 날짜를 기반으로 랜덤하게 메뉴 선택 (같은 날짜는 항상 같은 메뉴)
            const dateHash = date.split('-').join('').toString();
            const menuIndex = parseInt(dateHash) % randomMenus.length;
            return randomMenus[menuIndex];
